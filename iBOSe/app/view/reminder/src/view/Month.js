 ...
 */
Ext.define('iBOSe.view.reminder.src.view.Month', {
    ...
    initDD: function() {
        ...
        this.dragZone = new iBOSe.view.reminder.src.dd.DragZone(this.el, cfg);
        this.dropZone = new iBOSe.view.reminder.src.dd.DropZone(this.el, cfg);
    },
    ...
    afterRender: function() {
        if (!this.tpl) {
            this.tpl = new iBOSe.view.reminder.src.template.Month({
                id: this.id,
    ...
    renderItems: function() {
    	iBOSe.view.reminder.src.util.WeekEventRenderer.render({
    ...
    getDayAt: function(x, y) {
        var box = this.el.getBox(),
            ...
            days = (dayT * 7) + dayL,
            dt = iBOSe.view.reminder.src.util.Date.add(this.viewStart, {days: days});
        return {
            date: dt,
            el: this.getDayEl(dt)
        };
    ...
    onClick: function(e, t) {
        ...
        if (iBOSe.view.reminder.src.view.Month.superclass.onClick.apply(this, arguments)) {
