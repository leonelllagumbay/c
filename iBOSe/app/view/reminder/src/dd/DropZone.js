 ...
 */
Ext.define('iBOSe.view.reminder.src.dd.DropZone', {
    ...
    shim: function(start, end) {
        ...
        var dt = Ext.Date.clone(start),
            ...
            shim,
            box,
            D = iBOSe.view.reminder.src.util.Date,
    ...
    onNodeDrop: function(n, dd, e, data) {
        if (n && data) {
            if (data.type == 'eventdrag') {
                ...
                dt = iBOSe.view.reminder.src.util.Date.copyTime(rec.data[iBOSe.view.reminder.src.data.EventMappings.StartDate.name], n.date);
