 ...
 * @xtype calendarpanel
 */
Ext.define('iBOSe.view.reminder.src.CalendarPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.calendarpanel',
    
    requires: [
        'Ext.layout.container.Card',
        'iBOSe.view.reminder.src.view.Day',
        'iBOSe.view.reminder.src.view.Week',
        'iBOSe.view.reminder.src.view.Month',
        'iBOSe.view.reminder.src.form.EventDetails'
    ],
    ...
    onEventAdd: function(form, rec) {
        rec.data[iBOSe.view.reminder.src.data.EventMappings.IsNew.name] = false;
        this.hideEditForm();
