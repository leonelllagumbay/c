 ...
 */
Ext.define('iBOSe.view.reminder.src.App', {
    ...
    requires: [
        ...
        'iBOSe.view.reminder.src.CalendarPanel',
        'iBOSe.view.reminder.src.data.MemoryCalendarStore',
        'iBOSe.view.reminder.src.data.MemoryEventStore',
        'iBOSe.view.reminder.src.data.Events',
        'iBOSe.view.reminder.src.data.Calendars',
        'iBOSe.view.reminder.src.form.EventWindow',
        'iBOSe.view.reminder.src.data.CalendarModel',
        'iBOSe.view.reminder.src.data.EventModel'
    ],
    ...
    initComponent : function() {
        ...
        this.calendarStore = Ext.create('iBOSe.view.reminder.src.data.MemoryCalendarStore', {
            data: iBOSe.view.reminder.src.data.Calendars.getData()
        });

        // A sample event store that loads static JSON from a local file. Obviously a real
        // implementation would likely be loading remote data via an HttpProxy, but the
        // underlying store functionality is the same.
        this.eventStore = Ext.create('iBOSe.view.reminder.src.data.MemoryEventStore', {
            data: iBOSe.view.reminder.src.data.Events.getData()
        });
        ...
        this.items = [{
                ...
                items: [{
                    ...
                    listeners: {
                        ...
                        'eventmove': {
                            fn: function(vw, rec){
                                var mappings = iBOSe.view.reminder.src.data.EventMappings,
            ...
            this.callParent(arguments); // this is important if you encounter null items problem
    },
    ...
    showEditWindow : function(rec, animateTarget){
        if(!this.editWin){
            this.editWin = Ext.create('iBOSe.view.reminder.src.form.EventWindow', {
                calendarStore: this.calendarStore,
                listeners: {
                    'eventadd': {
                        fn: function(win, rec){
