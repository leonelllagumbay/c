 ...
 */
Ext.define('iBOSe.view.reminder.src.form.EventWindow', {
    ...
    show: function(o, animateTarget) {
        ...
        if (o.data) {
            ...
            var start = o[M.StartDate.name],
                end = o[M.EndDate.name] || iBOSe.view.reminder.src.util.Date.add(start, {hours: 1});
            
            data[M.StartDate.name] = start;
            data[M.EndDate.name] = end;
            data[M.IsAllDay.name] = !!o[M.IsAllDay.name] || start.getDate() != iBOSe.view.reminder.src.util.Date.add(end, {millis: 1}).getDate();
            rec = new iBOSe.view.reminder.src.data.EventModel(data);
