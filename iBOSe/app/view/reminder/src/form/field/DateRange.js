 ...
 */
Ext.define('iBOSe.view.reminder.src.form.field.DateRange', {
     ...
     */
    getValue: function(){
        var eDate = iBOSe.view.reminder.src.util.Date,
    ...
    setValue: function(v){
        ...
        else if(v[iBOSe.view.reminder.src.data.EventMappings.StartDate.name]){ //object
            this.setDT(v[iBOSe.view.reminder.src.data.EventMappings.StartDate.name], 'start');
            if(!this.setDT(v[iBOSe.view.reminder.src.data.EventMappings.EndDate.name], 'end')){
                this.setDT(v[iBOSe.view.reminder.src.data.EventMappings.StartDate.name], 'end');
            }
            this.allDay.setValue(!!v[iBOSe.view.reminder.src.data.EventMappings.IsAllDay.name]);
        }
    },
